...
- all five glass levels apply live across open app chrome, visibly change both Library panes, persist atomically, and leave high contrast and the dense recording HUD unchanged;
